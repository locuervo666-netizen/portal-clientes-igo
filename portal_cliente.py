...
def conectar_banco_seguro():
    try:
        ...
        elif "google_cred_json" in st.secrets:
    ...
    if not df_raw.empty:
        ...
        if not df_cliente.empty:
            ...
            with st.sidebar:
                ...
                col_vis = st.multiselect("Ver:", options=['DATA', 'PEDIDO', 'STATUS', 'LABORATORIO', 'CIDADE', 'UF', 'BAIRRO', 'DATA_LIMITE', 'FOTO_URL'], default=['DATA', 'PEDIDO', 'STATUS', 'LABORATORIO', 'CIDADE', 'UF', 'BAIRRO', 'DATA_LIMITE', 'FOTO_URL'])
                st.divider()
                # WHATSAPP E EXCEL FILTRADOS
            ...
            # BUSCA RÁPIDA (ABAIXO DO PROGRESSO)
            ...
            # SIDEBAR - EXPORTAÇÃO E WHATSAPP DO QUE ESTÁ NA TELA
            with st.sidebar:
