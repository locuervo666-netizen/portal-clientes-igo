...
def despachar_para_appsheet(lista_pedidos_dicts):
    if not planilha_db or not lista_pedidos_dicts: 
        return False
    try:
...
# =============================================================================
# 🚀 MÓDULO 1: DASHBOARD (MUITO IMPORTANTE: GRID PURA)
# =============================================================================
if menu == "📊 Dashboard":
    ...
    if not df_raw.empty:
        ...
        # LIMPEZA FORÇADA PARA EVITAR CRASH
        ...
        with container_grid:
            # 🔥 GRID TOTALMENTE PURA, SEM JAVASCRIPT QUEBRANDO A TELA
            ...
            gb.configure_column("DATA_ENTREGA", headerName="Data Real Entrega")
            gb.configure_column("STATUS_DISPLAY", headerName="Status")
            gb.configure_column("FOTO_URL", headerName="Link da Foto")
    ...
    if not df_raw.empty:
        ...
        with t1:
            ...
            if not df_fila.empty:
                ...
                gb_fila.configure_selection('multiple', use_checkbox=True)
