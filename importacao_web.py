    ...
    if not df_raw.empty:
        ...
        if st.session_state.filtro_kpi_admin != "TODOS":
            if st.session_state.filtro_kpi_admin == "HOJE": 
                ...
                df_grid = df_grid[df_grid['STATUS_DISPLAY'].str.contains(st.session_state.filtro_kpi_admin, case=False)]
            ...
            if st.button("🚀 3. INJETAR LOTE", type="primary"):
                with st.spinner("🚀 Injetando lotes no banco de dados e gerando IDs..."):
                    try:
                        ...
                        if 'ZAP_ENVIADO' not in df_up.columns: 
                            df_up['ZAP_ENVIADO'] = ""
