...
if menu == "📊 GRID":
    ...
    if not df_raw.empty:
        ...
        # 🔥 BLOCO DE BOTÕES ABSOLUTAMENTE COMPLETO 🔥
        with box_botoes.container():
            ...
            # 3. TROCAR AGENTE (ENVIANDO PRO APP)
            ...
            # 5. EXCLUIR DEFINITIVAMENTE (LIMPANDO APPSHEET TAMBÉM)
